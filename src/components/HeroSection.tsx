  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/3 right-1/4 w-[500px] h-[500px] bg-forest-light/20 rounded-full blur-[120px] animate-pulse-slow" style={{ animationDelay: '2s' }} />
      </div>
            ...
            <div className="absolute left-1/2 -translate-x-1/2 bottom-[-8%] z-20 flex items-center justify-center gap-2 sm:gap-3 md:gap-4 whitespace-nowrap">
              {["I'M", "YOUR", "MAN"].map((word, index) => (
                <motion.span
                  ...
                  style={{ textShadow: '0 2px 12px hsl(155 40% 6% / 0.9), 0 0 30px hsl(42 85% 55% / 0.5)' }}
