  ...
  const benefits = [
    {
      icon: Users,
      title: t('career.team'),
      description: t('career.team.desc')
    },
    {
      icon: TrendingUp,
      title: t('career.growth'),
      description: t('career.growth.desc')
    },
    {
      icon: Heart,
      title: t('career.balance'),
      description: t('career.balance.desc')
    },
    {
      icon: Briefcase,
      title: t('career.variety'),
      description: t('career.variety.desc')
    }
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-space-grotesk mb-6">
              {t('career.title')} <span className="text-gradient">IYM</span>
            </h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold font-space-grotesk text-center mb-12">
            {t('career.why')} <span className="text-gradient">IYM</span>?
          </h2>
            ...
            <div className="glass rounded-3xl p-8 md:p-12">
              ...
              <form className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="position" placeholder={t('career.position.placeholder')} required />
                </div>
                
                <div className="space-y-2">
                  <Label htmlFor="message">{t('career.aboutyou')} *</Label>
                  <Textarea
                    id="message"
                    placeholder={t('career.aboutyou.placeholder')}
                    rows={5}
                    required
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="cv">{t('career.cv')}</Label>
