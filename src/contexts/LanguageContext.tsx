...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    'service.entruempelung': 'Entrümpelung',
    'service.entruempelung.desc': 'Schnelle und saubere Entrümpelung von Wohnungen und Gewerbeobjekten.',
    'service.hausmeister': 'Hausmeisterservice',
    'service.hausmeister.desc': 'Umfassender Hausmeisterservice für Ihr Gebäude oder Ihre Anlage.',
    'service.reparatur': 'Reparaturservice',
    'service.reparatur.desc': 'Schnelle und fachgerechte Reparaturen aller Art.',
    'service.garten': 'Gartenpflege',
    'service.garten.desc': 'Professionelle Garten- und Landschaftspflege rund ums Jahr.',
    'service.hochdruck': 'Hochdruckreinigung',
    'service.hochdruck.desc': 'Gründliche Reinigung von Terrassen, Fassaden und Einfahrten.',
    'service.auto': 'Auto Service',
    'service.auto.desc': 'Mobiler Reifenwechsel, Zentralverriegelung und Einparkhilfe Einbau.',
    'service.autofind': 'Auto Find Service',
    'service.autofind.desc': 'Professionelle Prüfung und Suche Ihres Traumwagens mit Expertise.',
    'service.detailing': 'Car Detailing',
    'service.detailing.desc': 'Professionelle Fahrzeugaufbereitung für Innen- und Außenbereich.',
    ...
    'about.quote': 'Was auch immer Sie brauchen, wir haben den Mann für Ihren Job.',
  ...
  en: {
    ...
    'service.entruempelung': 'Clearance',
    'service.entruempelung.desc': 'Fast and clean clearance of apartments and commercial properties.',
    'service.hausmeister': 'Caretaker Service',
    'service.hausmeister.desc': 'Comprehensive caretaker service for your building or facility.',
    'service.reparatur': 'Repair Service',
    'service.reparatur.desc': 'Fast and professional repairs of all kinds.',
    'service.garten': 'Garden Care',
    'service.garten.desc': 'Professional garden and landscape care all year round.',
    'service.hochdruck': 'Pressure Washing',
    'service.hochdruck.desc': 'Thorough cleaning of terraces, facades and driveways.',
    'service.auto': 'Auto Service',
    'service.auto.desc': 'Mobile tire change, central locking and parking assist installation.',
    'service.autofind': 'Auto Find Service',
    'service.autofind.desc': 'Professional inspection and search for your dream car with expertise.',
    'service.detailing': 'Car Detailing',
    'service.detailing.desc': 'Professional vehicle preparation for interior and exterior.',
    ...
    'about.quote': 'Whatever you need, we have the man for your job.',
  ...
  ru: {
    ...
    'service.entruempelung': 'Вывоз мусора',
    'service.entruempelung.desc': 'Быстрая и чистая уборка квартир и коммерческих объектов.',
    'service.hausmeister': 'Управдом',
    'service.hausmeister.desc': 'Комплексные услуги управляющего для вашего здания.',
    'service.reparatur': 'Ремонтные услуги',
    'service.reparatur.desc': 'Быстрый и профессиональный ремонт любого вида.',
    'service.garten': 'Уход за садом',
    'service.garten.desc': 'Профессиональный уход за садом и ландшафтом круглый год.',
    'service.hochdruck': 'Мойка высокого давления',
    'service.hochdruck.desc': 'Тщательная очистка террас, фасадов и подъездных путей.',
    'service.auto': 'Авто сервис',
    'service.auto.desc': 'Мобильная замена шин, установка центрального замка и парктроника.',
    'service.autofind': 'Поиск авто',
    'service.autofind.desc': 'Профессиональная проверка и поиск автомобиля вашей мечты.',
    'service.detailing': 'Детейлинг авто',
    'service.detailing.desc': 'Профессиональная подготовка автомобиля внутри и снаружи.',
    ...
    'about.quote': 'Что бы вам ни понадобилось, у нас есть человек для вашей работы.',
